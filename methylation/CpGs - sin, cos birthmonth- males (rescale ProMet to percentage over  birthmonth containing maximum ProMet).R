...
SS=read_xlsx("all_DNAm_mice_all_tissues.xlsx") %>% distinct() %>%
  filter(CanBeUsedForAgingStudies == 'yes' & Tissue == "Tail"  & Sex == "M")
...
write.xlsx(BW_scan, './data/BWanno - CpGs - sin, cos - circannual birthmonth - males.xlsx')
...
ggsave("./data/methylation level across birthmonth/males - all.png", plot = plot_all, width = 10, height = 8, dpi = 300)
...
# Save the plot with a full path specification
ggsave("./data/methylation level across birthmonth/males - high in Sep.png", plot = plot_high, width = 10, height = 8, dpi = 300)
...
# Save the plot with a full path specification
ggsave("./data/methylation level across birthmonth/males - low in Sep.png", plot = plot_low, width = 10, height = 8, dpi = 300)
...
# Save the plot with a full path specification
ggsave("./data/methylation level across birthmonth/males - middle in Sep.png", plot = plot_middle, width = 10, height = 8, dpi = 300)
...
write.xlsx(summary_table, "./data/methylation level across birthmonth/summary_table - males.xlsx")
