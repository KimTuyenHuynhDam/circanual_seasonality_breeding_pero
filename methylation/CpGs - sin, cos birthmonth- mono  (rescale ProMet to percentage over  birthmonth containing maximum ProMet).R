...
ggsave("./data/methylation level across birthmonth/mono - all.png", plot = plot_all, width = 10, height = 8, dpi = 300)
...
# Save the plot with a full path specification
ggsave("./data/methylation level across birthmonth/mono - high in Sep.png", plot = plot_high, width = 10, height = 8, dpi = 300)
...
# Save the plot with a full path specification
ggsave("./data/methylation level across birthmonth/mono - low in Sep.png", plot = plot_low, width = 10, height = 8, dpi = 300)
...
# Save the plot with a full path specification
ggsave("./data/methylation level across birthmonth/mono - middle in Sep.png", plot = plot_middle, width = 10, height = 8, dpi = 300)
...
write.xlsx(summary_table, "./data/methylation level across birthmonth/summary_table - mono.xlsx")
