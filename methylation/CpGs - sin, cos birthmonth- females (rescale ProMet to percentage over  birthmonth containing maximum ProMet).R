...
SS=read_xlsx("all_DNAm_mice_all_tissues.xlsx") %>% distinct() %>%
  filter(CanBeUsedForAgingStudies == 'yes' & Tissue == "Tail"  & Sex == "F")
...
write.xlsx(BW_scan, './data/BWanno - CpGs - sin, cos - circannual birthmonth - females.xlsx')
...
ggsave("./data/methylation level across birthmonth/females - all.png", plot = plot_all, width = 10, height = 8, dpi = 300)
...
# Save the plot with a full path specification
ggsave("./data/methylation level across birthmonth/females - high in Sep.png", plot = plot_high, width = 10, height = 8, dpi = 300)
...
# Save the plot with a full path specification
ggsave("./data/methylation level across birthmonth/females - low in Sep.png", plot = plot_low, width = 10, height = 8, dpi = 300)
...
# Save the plot with a full path specification
ggsave("./data/methylation level across birthmonth/females - middle in Sep.png", plot = plot_middle, width = 10, height = 8, dpi = 300)
...
write.xlsx(summary_table, "./data/methylation level across birthmonth/summary_table - females.xlsx")
